    ...
    <section id="headlineObjectives" className={styles.headlineObjectivesSection}>
     {/*  <div className={styles.label}>
      ...
      <div className={styles.projectsContainer}>
        ...
        Volunteering Opportunities for Inclusion and Competence development of disabled individuals within supported Employment  
        <div className={styles.projectName}>
        2024-2-PT01-KA210-VET-000270713
        </div>
        </div>
